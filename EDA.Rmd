...
```{r datamanip, message=FALSE, warnings= FALSE, echo=TRUE}
data1<-data
...
```{r correlation_creation, message=FALSE, warnings= FALSE, echo=TRUE}
library(showtext)
font_add_google("Courier Prime", "Courier")
showtext_auto()
...
```{r plot corrr, message=FALSE, warnings=FALSE}
...
```{r plotcov, echo=TRUE, message=FALSE, warnings=FALSE}
